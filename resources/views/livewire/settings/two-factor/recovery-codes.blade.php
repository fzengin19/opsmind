...
<div class="py-6 space-y-6 border shadow-sm rounded-xl border-zinc-200 dark:border-white/10" wire:cloak
    ...
    <div class="px-6 space-y-2">
        <div class="flex items-center gap-2">
            ...
            <flux:heading size="lg" level="3">{{ __('settings.2fa.recovery_codes') }}</flux:heading>
        </div>
        <flux:text variant="subtle">
            {{ __('settings.2fa.recovery_desc') }}
        </flux:text>
    </div>
            ...
            <div class="mt-3 space-y-3">
                ...
                @if (filled($recoveryCodes))
                    ...
                    <flux:text variant="subtle" class="text-xs">
                        {{ __('settings.2fa.recovery_usage') }}
                    </flux:text>
                @endif
            </div>
        </div>
